...
function $c512c27ab02ef895$export$50c7b4e9d9f19c12(scopeName, createContextScopeDeps = []) {
  let defaultContexts = [];
  function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
    const BaseContext = (0, import_react8.createContext)(defaultContext);
    const index = defaultContexts.length;
    defaultContexts = [
      ...defaultContexts,
      defaultContext
    ...
    function Provider(props) {
      ...
      return (0, import_react8.createElement)(Context.Provider, {
        value
      }, children);
    }
    function useContext(consumerName, scope) {
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return (0, import_react8.createContext)(defaultContext);
    });
    return function useScope(scope) {
      const contexts = (scope === null || scope === void 0 ? void 0 : scope[scopeName]) || scopeContexts;
...
function $6ed0406888f73fc4$export$c7b2cbe3552a0d052(...refs) {
  return (0, import_react12.useCallback)($6ed0406888f73fc4$export$43e446d32b3d21af2(...refs), refs);
}
...
var $409067139f391064$export$6eb0f7ddcda6131f = (0, import_react16.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react16.createElement)($409067139f391064$var$CollapsibleProvider, {
  ...
  }, (0, import_react16.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d0342.div, _extends({
...
var $409067139f391064$export$c135dce7b15bbbdc = (0, import_react16.forwardRef)((props, forwardedRef) => {
  const { __scopeCollapsible, ...triggerProps } = props;
  const context = $409067139f391064$var$useCollapsibleContext($409067139f391064$var$TRIGGER_NAME, __scopeCollapsible);
  return (0, import_react16.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d0342.button, _extends({
    type: "button",
...
var $409067139f391064$export$aadde00976f34151 = (0, import_react16.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react16.createElement)(
    ...
    ({ present }) => (0, import_react16.createElement)($409067139f391064$var$CollapsibleContentImpl, _extends({}, contentProps, {
      ref: forwardedRef,
      present
    }))
  );
...
var $409067139f391064$var$CollapsibleContentImpl = (0, import_react16.forwardRef)((props, forwardedRef) => {
  const { __scopeCollapsible, present, children, ...contentProps } = props;
  const context = $409067139f391064$var$useCollapsibleContext($409067139f391064$var$CONTENT_NAME, __scopeCollapsible);
  const [isPresent, setIsPresent] = (0, import_react16.useState)(present);
  const ref = (0, import_react16.useRef)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d052(forwardedRef, ref);
  const heightRef = (0, import_react16.useRef)(0);
  const height = heightRef.current;
  const widthRef = (0, import_react16.useRef)(0);
  const width = widthRef.current;
  const isOpen = context.open || isPresent;
  const isMountAnimationPreventedRef = (0, import_react16.useRef)(isOpen);
  const originalStylesRef = (0, import_react16.useRef)();
  ...
  return (0, import_react16.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d0342.div, _extends({
    "data-state": $409067139f391064$var$getState(context.open),
    "data-disabled": context.disabled ? "" : void 0,
...
var $1bf158f521e1b1b4$export$a766cd26d0d69044 = import_react19.default.forwardRef((props, forwardedRef) => {
  const { type, ...accordionProps } = props;
  const singleProps = accordionProps;
  const multipleProps = accordionProps;
  return import_react19.default.createElement($1bf158f521e1b1b4$var$Collection.Provider, {
    scope: props.__scopeAccordion
  }, type === "multiple" ? import_react19.default.createElement($1bf158f521e1b1b4$var$AccordionImplMultiple, _extends({}, multipleProps, {
    ref: forwardedRef
  })) : import_react19.default.createElement($1bf158f521e1b1b4$var$AccordionImplSingle, _extends({}, singleProps, {
    ref: forwardedRef
  })));
});
...
var $1bf158f521e1b1b4$var$AccordionImplSingle = import_react19.default.forwardRef((props, forwardedRef) => {
  ...
  return import_react19.default.createElement($1bf158f521e1b1b4$var$AccordionValueProvider, {
    scope: props.__scopeAccordion,
    value: value ? [
      value
    ] : [],
    onItemOpen: setValue,
    onItemClose: import_react19.default.useCallback(
  ...
  }, import_react19.default.createElement($1bf158f521e1b1b4$var$AccordionCollapsibleProvider, {
    scope: props.__scopeAccordion,
    collapsible
  }, import_react19.default.createElement($1bf158f521e1b1b4$var$AccordionImpl, _extends({}, accordionSingleProps, {
    ref: forwardedRef
  }))));
});
var $1bf158f521e1b1b4$var$AccordionImplMultiple = import_react19.default.forwardRef((props, forwardedRef) => {
  const { value: valueProp, defaultValue, onValueChange = () => {
  ...
  return import_react19.default.createElement($1bf158f521e1b1b4$var$AccordionValueProvider, {
    ...
    scope: props.__scopeAccordion,
    collapsible: true
  }, import_react19.default.createElement($1bf158f521e1b1b4$var$AccordionImpl, _extends({}, accordionMultipleProps, {
    ref: forwardedRef
  }))));
});
...
var $1bf158f521e1b1b4$var$AccordionImpl = import_react19.default.forwardRef((props, forwardedRef) => {
  ...
  return import_react19.default.createElement($1bf158f521e1b1b4$var$AccordionImplProvider, {
    scope: __scopeAccordion,
    disabled,
    direction: dir,
    orientation
  }, import_react19.default.createElement($1bf158f521e1b1b4$var$Collection.Slot, {
    scope: __scopeAccordion
  }, import_react19.default.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, accordionProps, {
...
var $1bf158f521e1b1b4$export$d99097c13d4dac9f = import_react19.default.forwardRef((props, forwardedRef) => {
  ...
  return import_react19.default.createElement($1bf158f521e1b1b4$var$AccordionItemProvider, {
    scope: __scopeAccordion,
    open: open1,
    disabled,
    triggerId
  }, import_react19.default.createElement($409067139f391064$export$be92b6f5f03c0fe9, _extends({
...
var $1bf158f521e1b1b4$export$5e3e5deaaf81ee41 = import_react19.default.forwardRef((props, forwardedRef) => {
  ...
  return import_react19.default.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.h3, _extends({
    "data-orientation": accordionContext.orientation,
...
var $1bf158f521e1b1b4$export$94e939b1f85bdd73 = import_react19.default.forwardRef((props, forwardedRef) => {
  ...
  const collapsibleScope = $1bf158f521e1b1b4$var$useCollapsibleScope(__scopeAccordion);
  return import_react19.default.createElement($1bf158f521e1b1b4$var$Collection.ItemSlot, {
    scope: __scopeAccordion
  }, import_react19.default.createElement($409067139f391064$export$41fb9f06171c75f4, _extends({
...
var $1bf158f521e1b1b4$export$985b9a77379b54a0 = import_react19.default.forwardRef((props, forwardedRef) => {
  ...
  const collapsibleScope = $1bf158f521e1b1b4$var$useCollapsibleScope(__scopeAccordion);
  return import_react19.default.createElement($409067139f391064$export$7c6e2c02157bb7d2, _extends({
    role: "region",
